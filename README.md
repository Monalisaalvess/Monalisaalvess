...
Olá! Me chamo Monalisa, estudante de Análise e Desenvolvimento de Sistemas pela UNIGRANDE (4º semestre), apaixonada por criar interfaces bonitas e funcionais. Estou em transição para a área de desenvolvimento Full Stack, buscando minha primeira oportunidade de estágio.

| | |
|---|---|
| 🎓 | Cursando ADS — UNIGRANDE (previsão: dez/2026) |
| 💻 | Focada em HTML, CSS, JavaScript, React e Node.js |
| 📚 | Aprendendo React, TypeScript e boas práticas de UI |
| 📍 | Crato, CE — disponível para mudança |
